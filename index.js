...
var fnvplus = (function(){
	...
	function seed(seed) {
		...
		for (var keysize in fnvConstants) {
			if(keysize == 32){
				fnvConstants[keysize].offset = 0;
				fnvConstants[keysize].offset = hash(seed, parseInt(keysize, 10)).value;
			}else{
				fnvConstants[keysize].offset = [];
				for(i = 0; i < keysize / 16; i++){
					fnvConstants[keysize].offset[i]	= 0;
				}
				res = hash(seed, parseInt(keysize, 10)).value;
				for(i = 0; i < keysize / 16; i++){
	...
	function _hash32_1a(str) {
		var i, hash = fnvConstants[32].offset | 0;

		for (i = 0; i < str.length; i++) {
			hash^=str.charCodeAt(i);
			hash+=hash*402+(hash<<24);
		}
		return hashValInt32(hash >>> 0, 32);
	}
	...
	var _hash32 = _hash32_1a;

	function _hash32_1a_fast(str) {
		var i, hash = 0x811c9dc5;
	...
	function _hash32_1a_fast_hex(str) {
		...
		return hl[hash>>>24]+hl[(hash>>>16)&255]+hl[(hash>>>8)&255]+hl[hash&255];
	}

	function _hash52_1a(str){
		var i,s=fnvConstants[64].offset,t0=0,v0=s[3]|0,t1=0,v1=s[2]|0,t2=0,v2=s[1]|0,t3=0,v3=s[0]|0;
	...
	var _hash52 = _hash52_1a;

	function _hash52_1a_fast(str){
		var i,t0=0,v0=0x2325,t1=0,v1=0x8422,t2=0,v2=0x9ce4,t3=0,v3=0xcbf2;
	...
	function _hash128_1a(str){
		var i,s=fnvConstants[128].offset,t0=0,v0=s[7]|0,t1=0,v1=s[6]|0,t2=0,v2=s[5]|0,t3=0,v3=s[4]|0,t4=0,v4=s[3]|0,t5=0,v5=s[2]|0,t6=0,v6=s[1]|0,t7=0,v7=s[0]|0;
	...
	var _hash128 = _hash128_1a;

	function _hash256_1a(str){
		var i,s=fnvConstants[256].offset,t0=0,v0=s[15]|0,t1=0,v1=s[14]|0,t2=0,v2=s[13]|0,t3=0,v3=s[12]|0,t4=0,v4=s[11]|0,t5=0,v5=s[10]|0,t6=0,v6=s[9]|0,t7=0,v7=s[8]|0,t8=0,v8=s[7]|0,t9=0,v9=s[6]|0,t10=0,v10=s[5]|0,t11=0,v11=s[4]|0,t12=0,v12=s[3]|0,t13=0,v13=s[2]|0,t14=0,v14=s[1]|0,t15=0,v15=s[0]|0;
